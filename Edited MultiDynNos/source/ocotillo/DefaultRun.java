...
import ocotillo.samples.parsers.PatientContacts10;
import ocotillo.samples.parsers.PatientContacts25;
...
//				return new CMDLineOption("Use Vanilla Tuning (MultiDynNoS only)", "--vT", "Sets layout tuning to vanilla MultiDynNoS.");				
	...
	public static void main(String[] args) throws Exception {
		...
		default: {
			...
			preloadedGraphs.put("patientcontacts10", 11);
			preloadedGraphs.put("patientcontacts25", 12);
			...
			if(preloadedGraphs.containsKey(selectedGraph)) {
				try {
					...
					case 11: loadMode = Mode.keepAppearedNode; experimentClass = "PatientContacts10"; data = new PatientContacts10().parse(loadMode); break;
					case 12: loadMode = Mode.keepAppearedNode; experimentClass = "PatientContacts25"; data = new PatientContacts25().parse(loadMode); break;
					default: break;
					}
				}catch (Exception e) {
...
//					}
		...
		case computeMetrics: {
			...
			smallerDatasets.add("PatientContacts10");
			smallerDatasets.add("PatientContacts25");
