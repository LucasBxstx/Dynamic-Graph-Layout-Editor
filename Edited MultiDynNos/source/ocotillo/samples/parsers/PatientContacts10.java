 ...
 */
public class PatientContacts10 extends PreloadedGraphParser{

	public static final String dataPath = "data/PatientContacts10/patients_raw_10_contacts.csv";
	...
	public DyDataSet parse(Mode mode) throws URISyntaxException {
		...
		try {
			InputStream fileStream = PatientContacts10.class.getClassLoader().getResourceAsStream(dataPath); 
