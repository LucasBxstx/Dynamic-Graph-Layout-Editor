 ...
 */
public class InfoVisCitations extends PreloadedGraphParser{

	public static final String dataPath = "data/InfoVis_citations/data.txt";
	 ...
	 * @throws Exception 
	 */
	private static Map<String, Paper> parsePapers(InputStream in) throws Exception {
	 ...
	 */
	//    private static DyGraph parseGraph(File file) {
	 ...
	 * @return the collaboration graph.
	 */
	private static DyGraph parseGraph(Map<String, Paper> papers, Mode mode) {
